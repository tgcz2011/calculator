...
if (typeof window.web3d !== "function") {
    window.web3d = GGBAppletUtils.makeModule("web3d",'864D576123B48EE4A1D5A2FE50444012');
}
if (typeof window.webSimple !== "function") {
    window.webSimple = GGBAppletUtils.makeModule("webSimple",'');
}
